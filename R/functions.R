...
tblinfo <- function(dat,custom_stats=alist()
                    ...
                    ,info_cols=alist(
                      ...
                      ,c_ordinal=uniquevals<min(10,nn)&uniquevals>0&isnum
                      ...
                      ,c_safe=frc_missing<.2 & frc_mostcommon < .7 &
                        !c_uninformative & !(!c_numeric & uniquevals > 15)
