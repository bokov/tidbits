...
[![Travis-CI Build Status](https://travis-ci.org/bokov/tidbits.svg?branch=master)](https://travis-ci.org/bokov/tidbits)
[![Coverage Status](https://img.shields.io/codecov/c/github/bokov/tidbits/master.svg)](https://codecov.io/github/bokov/tidbits?branch=integration)
[![AppVeyor Build Status](https://ci.appveyor.com/api/projects/status/github/bokov/tidbits?branch=master&svg=true)](https://ci.appveyor.com/project/bokov/tidbits)
